 ...
 */
public class HIBBELLW14CipherSerParameter extends PairingCipherSerParameter {
    ...
    public HIBBELLW14CipherSerParameter(PairingParameters pairingParameters, Element C0, Element C1, Element C2) {
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof HIBBELLW14CipherSerParameter) {
            HIBBELLW14CipherSerParameter that = (HIBBELLW14CipherSerParameter)anObject;
            //Compare C0
