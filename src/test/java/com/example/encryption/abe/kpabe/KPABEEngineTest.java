...
public class KPABEEngineTest {
    ...
    private void test_valid_access_policy(AsymmetricKeySerParameter publicKey, AsymmetricKeySerParameter masterKey,
        ...
        try {
            ...
            test_access_policy(publicKey, masterKey, accessPolicy, rhos, attributes);
        } catch (Exception e) {
    ...
    private void test_invalid_access_policy(AsymmetricKeySerParameter publicKey, AsymmetricKeySerParameter masterKey,
                                            final String accessPolicyString, final String[] attributes) {
        try {
            int[][] accessPolicy = ParserUtils.GenerateAccessPolicy(accessPolicyString);
            String[] rhos = ParserUtils.GenerateRhos(accessPolicyString);
    ...
    private void test_access_policy(AsymmetricKeySerParameter publicKey, AsymmetricKeySerParameter masterKey,
                                          final int[][] accessPolicy, final String[] rhos, final String[] attributes)
        ...
        PairingKeyEncapsulationSerPair keyEncapsulationSerPair = engine.encapsulation(publicKey, attributes);
        ...
        //Decryption
        byte[] anSessionKey = engine.decapsulation(publicKey, secretKey, attributes, ciphertext);
