 ...
 */
public class IBBEDel07PublicKeyParameters  extends PairingKeyParameters {
    ...
    public IBBEDel07PublicKeyParameters(PairingParameters parameters, Element w, Element v, Element[] hs) {
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof IBBEDel07PublicKeyParameters) {
            IBBEDel07PublicKeyParameters that = (IBBEDel07PublicKeyParameters)anObject;
