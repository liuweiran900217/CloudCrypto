 ...
 */
public class KPABEHW14HeaderSerParameter extends PairingCipherSerParameter {
    ...
    public KPABEHW14HeaderSerParameter(
        ...
        this.byteArraysC3s = new byte[this.attributes.length][];
        ...
        for (int i = 0; i < this.attributes.length; i++) {
            ...
            Element C3 = C3s.get(this.attributes[i]).duplicate().getImmutable();
            this.C3s.put(this.attributes[i], C3);
