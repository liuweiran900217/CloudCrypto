 ...
 */
public class HIBBELLW17EncryptionGenerationParameter implements CipherParameters {
    ...
    public HIBBELLW17EncryptionGenerationParameter(
            Digest digest, CipherParameters publicKeyParameters, String[] ids, Element message) {
