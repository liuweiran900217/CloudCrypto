 ...
 */
public class PairingParametersGenerationParameters {
     ...
     */
    public PairingParametersGenerationParameters(PairingType pairingType, int rBitLength, int qBitLength) {
        switch (pairingType) {
            case TYPE_A:
            case TYPE_E:
     ...
     */
    public PairingParametersGenerationParameters(int n, int qBitLength) {
     ...
     */
    public PairingParametersGenerationParameters(SecureRandom secureRandom, int rBitLength) {
