...
public class KPABEHW14SecretKeySerParameter extends KPABERW13SecretKeySerParameter {
    public KPABEHW14SecretKeySerParameter(PairingParameters pairingParameters, AccessControlParameter accessControlParameter, Map<String, Element> K0s, Map<String, Element> K1s, Map<String, Element> K2s) {
