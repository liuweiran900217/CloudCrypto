...
public class SecurePrimeParameters implements CipherParameters {
    ...
    public static final SecurePrimeParameters RFC3526_2048BIT_MODP_GROUP = new SecurePrimeParameters(
            new BigInteger(
                    "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" +
                    "29024E088A67CC74020BBEA63B139B22514A08798E3404DD" +
                    "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245" +
    ...
    public static final SecurePrimeParameters RFC3526_3072BIT_MODP_GROUP = new SecurePrimeParameters(
            new BigInteger(
                    "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" +
                    "29024E088A67CC74020BBEA63B139B22514A08798E3404DD" +
                    "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245" +
    ...
    public static final SecurePrimeParameters RFC3526_4096BIT_MODP_GROUP = new SecurePrimeParameters(
            new BigInteger(
                    "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" +
                    "29024E088A67CC74020BBEA63B139B22514A08798E3404DD" +
                    "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245" +
    ...
    public static final SecurePrimeParameters RFC3526_6144BIT_MODP_GROUP = new SecurePrimeParameters(
            new BigInteger(
    ...
    public static final SecurePrimeParameters RFC3526_8192BIT_MODP_GROUP = new SecurePrimeParameters(
            new BigInteger(
                    "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" +
                    "29024E088A67CC74020BBEA63B139B22514A08798E3404DD" +
                    "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245" +
    ...
    public SecurePrimeParameters(BigInteger p, BigInteger q, BigInteger g) {
        this.p = p;
        this.q = q;
        this.g = g;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof SecurePrimeParameters)) {
            return false;
        }

        SecurePrimeParameters pm = (SecurePrimeParameters) obj;
