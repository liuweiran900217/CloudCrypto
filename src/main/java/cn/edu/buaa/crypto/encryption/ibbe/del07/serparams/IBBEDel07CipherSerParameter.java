 ...
 */
public class IBBEDel07CipherSerParameter extends PairingCipherSerParameter {
    ...
    public IBBEDel07CipherSerParameter(PairingParameters pairingParameters, Element C1, Element C2) {
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof IBBEDel07CipherSerParameter) {
            IBBEDel07CipherSerParameter that = (IBBEDel07CipherSerParameter)anObject;
            //Compare C1
