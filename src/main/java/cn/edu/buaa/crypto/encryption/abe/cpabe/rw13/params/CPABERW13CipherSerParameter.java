 ...
 */
public class CPABERW13CipherSerParameter extends PairingCipherSerParameter {
    ...
    public CPABERW13CipherSerParameter(PairingParameters pairingParameters, Element C0, Element[] C1s,
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof CPABERW13CipherSerParameter) {
            CPABERW13CipherSerParameter that = (CPABERW13CipherSerParameter)anObject;
            //Compare length
