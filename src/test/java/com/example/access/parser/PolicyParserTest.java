...
public class PolicyParserTest {
    ...
    private PolicyParserTest(PairingParameters pairingParameters, LSSSPolicyEngine lsssPolicyEngine) {
        this.lsssPolicyEngine = lsssPolicyEngine;
