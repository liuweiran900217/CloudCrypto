 ...
 */
public class CPABERW13DecryptionGenerator implements PairingDecryptionGenerator {
    ...
    public Element recoverMessage() throws InvalidCipherTextException {
        ...
        try {
            ...
            Element sessionKey = pairing.pairing(ciphertextParameter.getC0(), secretKeyParameter.getK0());
