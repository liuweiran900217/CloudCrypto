 ...
 */
public class HIBBELLW16aCipherSerParameter extends PairingCipherSerParameter {
    ...
    public HIBBELLW16aCipherSerParameter(PairingParameters pairingParameters, Element C0, Element C1, Element C2) {
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof HIBBELLW16aCipherSerParameter) {
            HIBBELLW16aCipherSerParameter that = (HIBBELLW16aCipherSerParameter) anObject;
            //Compare C0
