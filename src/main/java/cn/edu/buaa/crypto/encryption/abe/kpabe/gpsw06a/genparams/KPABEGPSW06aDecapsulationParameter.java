 ...
 *
 * Goyal-Pandey-Sahai-Waters small-universe KP-ABE session key decapsulation parameter.
 */
public class KPABEGPSW06aDecapsulationParameter  implements CipherParameters {
    ...
    public KPABEGPSW06aDecapsulationParameter(
